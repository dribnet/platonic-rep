...
model_name1 = 'nvidia/NV-Embed-v1'
...
for model_name in model_names:
    ...
    if model_name == 'nvidia/NV-Embed-v1':
        print("-> extracting embedding model...")
        language_model = language_model.embedding_model
    ...
    for p in range(2):
        ...
        feature_pairs.append(llm_feats)
...
def score_pairs(features1, features2):
    ...
    result = compute_score(
        ...
        "mutual_knn", topk=4, normalize=True, only_layer=None)
    return result
